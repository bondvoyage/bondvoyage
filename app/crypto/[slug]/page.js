...
export default async function CryptoPage({ params }) {
  ...
  if (!crypto) return <p className="text-center mt-10">No Article</p>;

  const { author, title, body, image, summary, imagecredit } = crypto.fields;
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="mb-8 space-y-2 [&>*]:!m-0">
        <p className="text-sm font-semibold text-blue-700 tracking-widest uppercase mb-2"> Crypto </p>
